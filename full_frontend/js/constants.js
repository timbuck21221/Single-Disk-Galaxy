...
const STAR_SUPERNOVA_CHANCE_RATE_RED_SUPERGIANT = 0.005;

const STAR_SUPERNOVA_GAS_RETURN_FRACTION = 0.78;
const STAR_SUPERNOVA_REMNANT_FRACTION = 0.22;

const STAR_WHITE_DWARF_MIN_REMNANT_MASS = 22.0;
const STAR_NEUTRON_STAR_MIN_REMNANT_MASS = 36.0;
const STAR_PULSAR_MIN_REMNANT_MASS = 46.0;
const STAR_BLACK_HOLE_MIN_REMNANT_MASS = 120.0;
...
const BLACK_HOLE_LOCAL_GRAVITY_STRENGTH = 1;

const BLACK_HOLE_INFLUENCE_RADIUS_BASE = 1.2;
